...
MTCNN::MTCNN()
{
	...
	v1.push_back("conv4-2");
	v1.push_back("prob1");
	v2.push_back("conv5-2");
	v2.push_back("prob1");
	v3.push_back("conv6-2");
	v3.push_back("conv6-3");
	v3.push_back("prob1");
	output_blob_names_.push_back(v1);
	output_blob_names_.push_back(v2);
	output_blob_names_.push_back(v3);
}
